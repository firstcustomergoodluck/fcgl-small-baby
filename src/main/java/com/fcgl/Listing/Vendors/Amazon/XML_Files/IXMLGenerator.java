...
public interface IXMLGenerator {
  ...
  /**
   * Generates the XML for listing products in Amazon. All XML files generated should go in the
   * 'feeds' package. The format for a file name is: (TBD: I was thinking data with epoch time, or
   * UTC time or a mixture of date with the requestId)
   *
   * @param productInformation List of List of ProductInformation objects which hold the data needed
   * for the XML.
   * @return The location of the XML file generated
   */
  String generateProductXML(ArrayList<ArrayList<IProductInformation>> productInformation,
      String requestId);
}
