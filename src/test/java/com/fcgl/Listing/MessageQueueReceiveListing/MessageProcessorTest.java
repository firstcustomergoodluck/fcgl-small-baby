...
class MessageProcessorTest {
  ...
  private String[] parameters = {"vendorId", "sku", "quantity", "title", "description", "currency",
      "barcode", "barcodeType", "price", "latency"};
  ...
  void messageToProductInformationInsertTest() {
    String[] values = {"1", "1", "1", "FCGL", "Startup for dummies", Currency.USD.getName(),
        "1234567", ProductIdentifierType.ISBN.getName(), "12.50", "1"};
    ...
    MessageToProductInformationResponse response = messageProcessor
        .messageToProductInformation(message1);
  ...
  void messageToProductInformationMissingParamsTest() {
    String[] values = {"1", "1", "1", "FCGL", "Startup for dummies", Currency.USD.getName(),
        "1234567", ProductIdentifierType.ISBN.getName()};
    String message1 = generateJsonFormattedMessage(values, parameters);
    messages.add(message1);
    MessageProcessor messageProcessor = new MessageProcessor(messages);
    MessageToProductInformationResponse response = messageProcessor
  ...
  void messageToProductInformationUpdate() {
    ...
    MessageToProductInformationResponse response2 = messageProcessor
        .messageToProductInformation(message1);
  ...
  void processMessageMultipleInsertTest() {
    String[] values1 = {"1", "1", "1", "FCGL", "Startup for dummies", Currency.USD.getName(),
        "1234567", ProductIdentifierType.ISBN.getName(), "12.50", "1"};
    String[] values2 = {"1", "2", "2", "FCGL2", "Startup for dummies2", Currency.USD.getName(),
        "12345672", ProductIdentifierType.ISBN.getName(), "12.52", "2"};
  ...
  void processMessageBadVendor() {
    String[] values1 = {"1", "1", "1", "FCGL", "Startup for dummies", Currency.USD.getName(),
        "1234567", ProductIdentifierType.ISBN.getName(), "12.50", "1"};
    String[] values2 = {"2", "1", "1", "FCGL", "Startup for dummies", Currency.USD.getName(),
        "1234567", ProductIdentifierType.ISBN.getName(), "12.50", "1"};
    String message1 = generateJsonFormattedMessage(values1, parameters);
    String message2 = generateJsonFormattedMessage(values2, parameters);
    messages.add(message1);
